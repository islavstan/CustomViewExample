...
public class SwagPoints extends View {
    ...
    //Size
    //In order to control the view dimension, we have to override View.onMeasure() method and calculate
...
//To draw the view, you have to override the onDraw(Canvas canvas) method.
    @Override
...
//		Log.d("onDraw", String.valueOf(mPoints));
    ...
    //When the user touch the screen, Android calls the onTouchEvent() method,
    // so we override View.onTouchEvent() to handle the user input gestures
    @Override
...
//					updateOnTouch(event);
    ...
    //Here we a method to convert from touch coordinate to the arc angle
